...
import com.sqs.enums.DriverType;
import com.sqs.enums.EnvironmentType;
...
public class WebDriverManager 
{
	...
	private WebDriver createLocalDriver() {
        ...
        case INTERNETEXPLORER : 
        	System.setProperty(INTERNETEXPLORER_DRIVER_PROPERTY, FileReaderManager.getInstance().getConfigReader().getDriverPath());
